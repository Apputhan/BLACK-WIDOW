...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
            ...
            msg1 = await query.message.reply(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        ...
                        [
                            InlineKeyboardButton("⚠️ 𝖢𝖺𝗇'𝗍 𝖠𝖼𝖼𝖾𝗌𝗌 ❓ 𝖢𝗅𝗂𝖼𝗄 𝖧𝖾𝗋𝖾 ⚠️", url=f'https://t.me/+eB3bzutpOD04Y2M1')
                        ]
                    ]
                )
            )
        ...
        buttons = [[
        InlineKeyboardButton('BX_BOTS', url='https://t.me/Movie_channel_0'),
        InlineKeyboardButton('ᴍᴏᴠɪᴇs', url='https://t.me/allinonemoviesforallin'),
